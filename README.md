...
└── requirements.txt                      # [DESARROLLADO] Dependencias del entorno de ejecución
...
* **Capa de Seguridad e Integridad:** Algoritmo de cifrado simétrico (AES-256) planificado en `src/utils/seguridad.py` para la protección de la información operativa sensible y datos de mantenimiento restringidos.
...
* **Módulo de Exportación Automatizada:** *[A DESARROLLAR A FUTURO]* Lógica alojada en `src/utils/reports.py` diseñada para compilar y exportar informes de gestión mensuales y semestrales en formatos PDF y Excel de forma automatizada.
